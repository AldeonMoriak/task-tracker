<template>
  <div v-if="tasks && tasks.length > 0" class="mt-4 font-vazir">
    <teleport to="body">
      ...
      >
        <div
          class="flex flex-col items-center justify-center p-5 w-72 h-72 rounded-md bg-white w-1/2 h-1/2"
        >
          <textarea
            :dir="direction"
    ...
    <transition-group name="list-complete" tag="div">
      ...
      >
        ...
        <div
          ...
          class="bg-gray-100 my-2 rounded-md p-2 transition ease-in-out duration-500 cursor-pointer"
