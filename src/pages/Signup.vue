...
const signup = async () => {
  await axios.post('http://backend-task-tracker.herokuapp.com/auth/signup', { email: 'test@test.com', password: password.value, username: username.value, name: 'مهران' }).then(res => {
    console.log(res)
  }).catch(err => {
    console.error(err)
  })
